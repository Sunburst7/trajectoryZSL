...
class BasicModel(nn.Module):
    def __init__(self, seen_classes, features_dim) -> None:
        super(BasicModel, self).__init__()
        self.known_thresholds:Dict[int, torch.Tensor] = {known_class : 0 for known_class in seen_classes} # 可见类的距离阈值
        self.distances:Dict[int, list] = {known_class : [] for known_class in seen_classes} # 每个可见类对应样本到聚类中心的距离
