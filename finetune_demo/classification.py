...
class PTBXL_Trainer:
    def __init__(self, args: Namespace):
        ...
        train_filepath = os.path.join('/data2/hh/data/ais_gps/train_seqLen_100_rate_0.8_isGZSL_False.pkl')
        valid_filepath = os.path.join('/data2/hh/data/ais_gps/valid_seqLen_100_rate_0.8_isGZSL_False.pkl')
        test_filepath = os.path.join('/data2/hh/data/ais_gps/test_seqLen_100_rate_0.8_isGZSL_False.pkl')


        self.train_dataloader = create_dataloader(train_filepath, args.batch_size)
        self.test_dataloader  = create_dataloader(valid_filepath, args.batch_size)
        self.val_dataloader   = create_dataloader(test_filepath, args.batch_size)
