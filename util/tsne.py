...
class Tsne():
    def __init__(self, feature_dim, num_class, seen_class, unseen_class, is_2d=False) -> None:
        # t-SNE降维处理
        ...
        self.tsne = TSNE(n_components=2 if is_2d == 2 else 3, perplexity=30, verbose=0, random_state=42)
        self.is_2d = is_2d
